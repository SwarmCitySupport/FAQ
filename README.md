...
<a id="playStore" href="#playStore"><b>Will the Swarm City app be downloadable in the playstore?</b></a> | No, we have decided against listing the Swarm City DApp in the Google or Apple playstores. We are creating a Decentralized App (DApp), we do not want to create limitations to suit Google or Apple guidelines
...
<a id="swtUseIt" href="#swtUseIt"><b>When/How can I use my SWT?</b></a> | The Swarm City Token (SWT) has been created to function within the Swarm City environment. SWT tokens will be exchanged as the only form of payment within the app 
...
<a id="swtMining" href="#swtMining"><b>Can I mine SWT?</b></a> | No, you can't mine SWT tokens 
